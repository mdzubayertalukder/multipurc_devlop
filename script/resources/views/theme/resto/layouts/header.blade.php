               ...
               <div class="col-lg-6 col-md-7 col-12">
                  ...
                  <div class="topbar-left">
                     <ul class="topbar-left-inner">
                        <li><i class="icofont-delivery-time"></i><span class="info"><a href="javascript:void(0)"><b>{{ __('Delivery Time ') }}:</b>{{ $average_times->delivery_time ?? '' }}</a></span></li>
                        <li><i class="icofont-food-cart"></i><span class="info"><b>{{ __('Contact Number ') }}:</b>{{ $average_times->pickup_time ?? '' }}</span></li>
                     </ul>
                  </div>
               </div>
