...
<li class="{{ Request::is('seller/product*') ? 'active' : '' }} {{ Request::is('seller/barcode*') ? 'active' : '' }}">
    ...
    <ul class="dropdown-menu" >
         <!--<li>
            <a class="nav-link" href="{{ url('/seller/show_product') }}">Show Product</a>
        </li>-->
        <li>
            <a class="nav-link" href="{{ url('/seller/product') }}">{{ __('Add Product') }}</a>
        </li>
        <li>
...
<li class="{{ Request::is('seller/sell_product*') ? 'active' : '' }} {{ Request::is('reseller*') ? 'active' : '' }}">
    <a class="nav-link has-dropdown" href="#">
        <i class="fas fa-box"></i>
        <span>Reseller Section</span>
    </a>
    <ul class="dropdown-menu" >
        <li><a class="nav-link" href="{{ url('/reseller/'.Auth()->user()->email) }}"><span>Sell My Product</span></a></li>
        <li><a class="nav-link" href="{{ url('/seller/reseller') }}"><span>Reseller</span></a></li>
    </ul>
</li>