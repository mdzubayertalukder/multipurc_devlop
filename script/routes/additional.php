...
Route::group(['domain' => env('APP_URL'),'middleware' => ['auth', 'web']], function () {
    ...
    Route::get('/payment/uddoktapay', '\App\Lib\Uddoktapay@status');
    Route::get('/payment/uddoktapaymerchant', '\App\Lib\UddoktapayMerchant@statussub');
...
Route::group(['middleware' => ['web','InitializeTenancyByDomain','PreventAccessFromCentralDomains','web','tenantenvironment']], function () {
    ...
    Route::get('/order/payment/uddoktapay', '\App\Lib\Uddoktapay@status');
    Route::get('/order/payment/uddoktapaymerchant', '\App\Lib\UddoktapayMerchant@statussub');
